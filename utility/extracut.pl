...
create_regcut(Module) :- 
   ...
   out(':- module( '),out(Module),output(', [ composite_stat/3, cutloop_trace/3, cutloop_rid/7, dko/8, dkodate/2, ex_departureday/4, ex_ntourstops/2, ex_passes4/6, hpl/4, regbus/1, route/3, xi/2 ] ).'),
