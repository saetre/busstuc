...
implicitq(_) --->  
    ...
    {\+ user:testmember(N,[direct,first,second,nearest,last,next,third,early,last,late,previous,central])}, 
    !,reject.   
...
nameq1(Ronning:lastname,Ronning isa lastname) ---> %% Ståle Rønning
    {value(teleflag,true)},
