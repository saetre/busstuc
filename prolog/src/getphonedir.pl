...
%    myflags(busflag,true), %% TA-060613
%    \+ myflags(teleflag,true), %% TA-080407 (not bor -> bro(
%    !,
...
hazardous_tagname(X):- %% TA-060213
 ...
 (   
    ...
    myflags(language,N),dict_module(N,L),L:cw(X);             %% tuc/dict_ %% TA-070612
