...
attributes( [Name=Value|Attributes], Seen, Namespaces ) -->
	...
	"=",
	spaces,
	attribute_myflags( Value, Namespaces ),
...
dtd( Namespaces0, Namespaces1 ) -->
	...
	spaces,
	quote( Quote ),
	entity_myflags( Quote, Namespaces0, String ),
	spaces,
	">",
...
entity_myflags( Quote, Namespaces, String, [Char|Plus], Minus ) :-
	( Char == Quote ->
		String = [],
		Minus = Plus
	; Char =:= "&" ->
	...
	; otherwise ->
		String = [Char|String1],
		entity_myflags( Quote, Namespaces, String1, Plus, Minus )
	).

attribute_myflags( String, Namespaces ) -->
	quote( Quote ),
...
attribute_layouts( Quote, Namespaces, Layout, String, [Char|Plus], Minus ) :-
	( Char == Quote ->
		...
		Minus = Plus
	; Char =:= "&" ->
		reference_in_myflags( Namespaces, Quote, Layout, String, Plus, Minus )
	; Char > 32, Char \== 160 ->
		( Layout == true ->
...
reference_in_entity( Namespaces, Quote, String, Plus, Minus ) :-
	...
	entity_myflags( Quote, Namespaces, String1, Mid, Minus ).
