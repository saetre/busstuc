...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%UNIT: /tuc/
:- module( fernando, [ adj_compl/6, adj_template/5, adjname_template/4, adjname_template2/3, adjnamecomp_template/3, adjnoun_template/4, adjustprep/3, adjust_year/3, % ?? adjname_template/5, ??
        ...
        rv_template/7,  screenmeasure/2,                        setvartype/2,     
        subject_object_test/3,  subtype0/2,    teen/1,         testconstraint/2,       thenwhat/3,     tidvarp/3, tv_template/5, type/2, 
...
:- use_module( facts, [ fact/1, isa/2 ] ).       %% RS-131225
