...
%% Generated by class regtopToBusTUC.TopRegUpdate on 2015-03-27 17:48:25.557
...
route_period(   tt, r1612_150330, date(2015,03,30),   date(2015,03,31) ).	%% lørdagEkstraRute
route_period(   tt, r1613_150330, date(2015,03,30),   date(2015,04,03) ).	%% Påskerute01_03apr
route_period(   tt, r1611_150330, date(2015,03,30),   date(2015,04,05) ).	%% 30_02_05_Påske
