...
default_period( tt, winter,  r160_180813).  %% 2016 Winter (Christmas/Spring?)
default_period( tt, summer,  r160_190101).  %% 2016 Summer
...
default_period( tt,previous, r160_180813 ).  %% 2016_1 Most recently period used %% RS-151219
