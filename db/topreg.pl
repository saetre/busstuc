...
%default_period( tt,previous, r160_190422 ).  %% 2016_1 Most recently period used %% RS-151219
%default_period( tt,previous, r160_200504 ).  %% 2016_1 Most recently period used %% RS-151219
%default_period( tt,previous, r160_211101 ).  %% 2016_1 Most recently period used %% RS-151219
default_period( tt,previous, r160_251124 ).  %% 2026_11 Most recently period used %% RS-260223
