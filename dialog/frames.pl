...
% partly(when::departure::before)

completeframe(
	[
        [ partly(when::departure), full(where::arrival), full(where::departure) ],
	[ partly(when::departure), full(where::direction), full(where::departure) ],
	[ partly(when::departure), full(where::direction), full(where::arrival) ]
	]
	).
