...
checkitem(tbu_arr, focus(OldFrame, Refer, clock(Time)), focus(NewFrame, Refer, [])) :-
    ...
    frame_setvalue_rec(OldFrame,  whenis::arrival::after, ?, OldFrame2),
    frame_setvalue_rec(OldFrame2, whenis::departure::after, ?, OldFrame3),
    frame_setvalue_rec(OldFrame3, whenis::departure::before, ?, OldFrame4),    
    frame_setvalue_rec(OldFrame4, whenis::arrival::before, Time, NewFrame).
...
checkitem(tbu_dep, focus(OldFrame, Refer, clock(Time)), focus(NewFrame, Refer, [])) :-
    ...
    frame_setvalue_rec(OldFrame,  whenis::arrival::after, ?, OldFrame2),
    frame_setvalue_rec(OldFrame2, whenis::arrival::before, ?, OldFrame3),
    frame_setvalue_rec(OldFrame3, whenis::departure::before, ?, OldFrame4),    
    frame_setvalue_rec(OldFrame4, whenis::departure::after, Time, NewFrame).
...
checkitem(tbu_day, focus(OldFrame, Refer, X), focus(NewFrame, Refer, X)) :-
    ...
    isday(Day),
    frame_setvalue_rec(OldFrame, whenis::day, Day, NewFrame).
...
checkitem(tbu_day, focus(OldFrame, Refer, X), focus(NewFrame, Refer, X)) :-
    ...
    frame_setvalue_rec(OldFrame, whenis::day, Tomorrow, NewFrame).

checkitem(tbu_day, focus(OldFrame, Refer, X), focus(NewFrame, Refer, X)) :-
    getcurrent(Cid),
    getcontext(Cid, context(Tql, _, _, _)),
    roundmember(srel/today/_/_/_, Tql),
    frame_setvalue_rec(OldFrame, whenis::day, ?, NewFrame).
...
checkitem(tbs_whichday, focus(Frame, Refer, _), focus(Frame, Refer, slot(where::departure))) :-
    frame_getvalue_rec(Frame, whenis::day, Day, _Type),
    write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'),
    write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'), nl,
...
checkitem(tbs_whichday, focus(Frame, Refer, _), focus(Frame, Refer, slot(where::departure))) :-
    write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'),
    write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'), nl,
    writeanswer(bcpbc(askfor(whenis::day))), nl.
...
checkanswer(TQL, _, whenis::day, OldFrame, NewFrame) :-
    roundmember(_ isa Day, TQL),
    isday(Day),
    frame_setvalue_rec(OldFrame, whenis::day, Day, NewFrame).
...
checkanswer(TQL, _, whenis::day, OldFrame, NewFrame) :-
    roundmember(srel/today/_/_/_, TQL),
    today(Today), 
    frame_setvalue_rec(OldFrame, whenis::day, Today, NewFrame).
